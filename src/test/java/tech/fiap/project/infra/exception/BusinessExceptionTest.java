...
//
//		BusinessException exception = new BusinessException(ERROR_KEY, HttpStatus.BAD_REQUEST, null);
//
...
//		BusinessException exception = new BusinessException(ERROR_KEY, HttpStatus.NOT_FOUND, metadata);
//
//		assertEquals(EXPECTED_MESSAGE, exception.getMessage());
