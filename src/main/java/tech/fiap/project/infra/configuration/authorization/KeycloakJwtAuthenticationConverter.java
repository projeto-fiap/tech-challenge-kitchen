...
//
/// **
// * Classe responsavel por converter o token gerado pelo Keycloak de maneira a atribuir
// os
// * authorities do jeito que o spring security utiliza.
// */
// @Component
...
//
// private final JwtGrantedAuthoritiesConverter defaultGrantedAuthoritiesConverter = new
...
// Set<String> rolesWithPrefix = new HashSet<>();
// JsonNode json = objectMapper.convertValue(jwt.getClaim("realm_access"),
// JsonNode.class);
// json.elements()
// .forEachRemaining(e -> e.elements().forEachRemaining(r ->
// rolesWithPrefix.add(createRole(r.asText()))));
...
// jsonNode.getValue().elements().forEachRemaining(e -> e.elements()
// .forEachRemaining(r -> rolesWithPrefix.add(createRole(jsonNode.getKey(),
// r.asText()))));
// }
// return rolesWithPrefix;
// }
